...
//    }
    ...
    //assemble
    $(photo).prepend('<img id="theImg" src="' + "https" + data.url.substring(5, data.url.length) + '.png" />');
    $(photo).append(tag);
    $(modal).append(close);
    $(modal).append(photo);
    $(modal).append(caption);

    $(thumbnail).prepend('<img id="theImg" src="' + "https" + data.thumbnailUrl.substring(5, data.thumbnailUrl.length)  + '.png" />');
    $(pin).append(groove);
    $(groove).append(metal);
